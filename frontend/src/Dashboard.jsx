      ...
      <div className="relative z-10 flex justify-center mt-8 gap-2 md:gap-4 flex-wrap px-4">
        {[
          ...
          <button 
            ...
            className={`px-4 md:px-6 py-2 rounded-full font-bold text-xs md:text-sm tracking-wider transition-all duration-300 border flex items-center gap-2 cursor-pointer ${
              activeTab === tab.id 
