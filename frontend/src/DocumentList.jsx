...
import { FileText, CheckCircle, Clock, Loader2, Database, Trash2, AlertTriangle } from 'lucide-react';
      ...
      <div className="grid gap-3">
        {documents.map((doc, index) => (
          ...
          >
              ...
              <div className="flex items-center gap-4">
                  {/* Status Badge */}
                  <div className={`px-3 py-1 rounded-full border flex items-center gap-2 text-xs font-bold tracking-wider ${
